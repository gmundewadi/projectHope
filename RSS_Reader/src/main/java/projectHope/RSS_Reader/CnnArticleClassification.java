 ...
 * @author Alex Black
 */
public class CnnArticleClassification {
    ...
    public static final String WORD_VECTORS_PATH = "~/Desktop/projectHope/dl4j-examples/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main(String[] args) throws Exception {
       ...
       // Word2VecSentimentRNN.downloadData();
        ...
        WordVectors wordVectors = WordVectorSerializer.loadStaticModel(new File("./vectors.txt"));
